...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered tax, GST & bills assistant for Indian small businesses — right inside WhatsApp. Hindi, Hinglish & English." },
      { name: "author", content: "TaxEasy" },
